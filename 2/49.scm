...
(segments->painter (list (make-segment (make-vect 0 0.6) (make-vect 0.1 0.5))
                         ...
                         (make-segment (make-vect 0.6 0.99) (make-vect 0.7 0.8))
                         (make-segment (make-vect 0.7 0.8) (make-vect 0.6 0.67))
                         (make-segment (make-vect 0.6 0.67) (make-vect 0.7 0.67))
                         (make-segment (make-vect 0.7 0.67) (make-vect 0.99 0.5))
                         (make-segment (make-vect 0.4 0.9) (make-vect 0.46 0.9))
                         (make-segment (make-vect 0.54 0.9) (make-vect 0.6 0.9))))
